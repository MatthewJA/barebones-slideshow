...
=== Description ===
A simple, easily CSS customisable slideshow. The slideshow is displayed simply as a `div` with ID `#barebones-slideshow`. The div contains images, and they have class `.barebones-slideshow-image`. This makes it easy to format.
